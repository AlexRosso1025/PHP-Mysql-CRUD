<?php
    ...
    if(isset($_POST['update_task'])){
        ...
        $query = "UPDATE tasks SET title = '$title', description = '$description' WHERE task_id = '$id'";
        mysqli_query($conn,$query);
        $_SESSION['message'] = 'Task Updated Successfully';
        $_SESSION['message-type'] = 'dark';
            ...
            <div class="col-md-4 mx-auto">
                <div class="card card-body">
                    <form action="edit_task.php?id=<?php echo $_GET['id']; ?>" method="POST">
                        ...
                        <input type="submit" class="btn btn-success btn-block" name="update_task" value="Edit Task">
                    </form>
                </div>
            </div>
        </div>
